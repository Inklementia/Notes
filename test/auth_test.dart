  ...
  group('Mock Authentification', () {
    ...
    test('Create user should delegate login function', () async {
      ...
      final badPasswordUser =
          provider.createUser(email: 'any@gmail.com', password: 'foobar');
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn(
    ...
    const user = AuthUser(email: 'example@gmail.com', isEmailVerified: false);
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(email: 'example@gmail.com', isEmailVerified: true);
    _user = newUser;
  }
}
